...
<p>We will continue using the \@TheRealDonaldTrump tweets. Thinking about the distribution we just created in *Waiting Times to Distributions*, where do you think most of the tweets will come from in our random sample?</p>
`r mcq(c("The first column as this is where we see the most observations.", "Anywhere! The first column is as likely as the last column.", "I think most of the observations in our sample will be around 500.", answer = "The first column as this is where we see the most observations."))`
