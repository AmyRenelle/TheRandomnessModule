...
<center><iframe src="https://player.vimeo.com/video/555031767" width="210" frameborder="0" allow="fullscreen" allowfullscreen></iframe></center> 
</td>
<td align="left" valign="top" width="30%" padding=10px>
<center><iframe src="https://player.vimeo.com/video/555033102" width="200" frameborder="0" allow="fullscreen" allowfullscreen></iframe></center>
</td>
<td align="left" valign="top" width="30%">
<center><iframe src="https://player.vimeo.com/video/555035531" width="300" height="80" frameborder="0" allow="fullscreen" allowfullscreen></iframe></center>
</td>
</tr>
</table>
...
::: {}
At a visit to the casino, a friend bets $20 on "black" at the roulette table. They did not consider what events had previously occurred before placing their bet, they just picked black and went for it! How likely are they to win?
...
`r mcq(c("Fairly likely", "They might win; they might not", "Fairly unlikely", answer = "They might win; they might not"))`

<body>
<ul style="color:gray !important;"><li>If you suggested your friend was fairly likely to win, why would black be more likely than red?</li>
<li>If you suggested your friend was fairly unlikely to win, why would red be more likely than black?</li></ul>
</body>
:::
...
Your other friend at the casino saw that the last five numbers to come up were all red. "It's a run of reds" they whisper to you, before placing a $20 bet on red. Do you think this friend is more likely to win than your friend who placed a bet on black?

`r mcq(c("I think this friend is more likely to win", "They might win; they might not", "I think this friend is less likely to win", answer = "They might win; they might not"))`

<ul style="color:gray !important;"><li>Does the roulette wheel remember what happened last time? Or the time before?</li> 
<li>Is each spin independent from the last? What does this mean for "runs of red"?</li> 
<li>Has the probability of a red number increased? Decreased? Stayed the same?</li></ul>
...
`r mcq(c("I would bet on black!", "Either!", "I would bet on red!", answer = "Either!"))`

<ul style="color:gray !important;"><li>If you said you would pick red or black, why?</li>
<li>Does the roulette wheel remember what happened last time? Or the time before? Does the last 30 outcomes affect the next outcome at all?</li></ul>
<br>
</div>
...
<tr>
<td align="left" valign="top" width="30%" padding=10px>
<center><iframe src="https://player.vimeo.com/video/557056993" width="210" frameborder="0" allow="fullscreen" allowfullscreen></iframe></center> 
</td>
<td align="left" valign="top" width="30%" padding=10px>
<center><iframe src="https://player.vimeo.com/video/557057322" width="200" frameborder="0" allow="fullscreen" allowfullscreen></iframe></center>
</td>
<td align="left" valign="top" width="30%">
<center><iframe src="https://player.vimeo.com/video/557065796" width="300" height="80" frameborder="0" allow="fullscreen" allowfullscreen></iframe></center>
</td>
</tr>
</table>
...
## 3.4 Chemistry
<p>Randomness is a key property the universe. As chemistry examines the building blocks of the universe, we typically have to deal with this random behaviour. For example, particles are known to move randomly.
<br>
<br>
...
Collect as many coins as you can! Let's start off with 10 coins and then add some more. Place 8 coins in one pile on the left and the last 2 coins in another pile of the right.<br>
...
`r hide("Explanation")`
8.333 but, we can't have a third of an atom! So, let's say 8 or 9.
`r unhide()`

Now, this is only in theory so let's simulate this! Sort the list below into groups according to how good they would be to use for simulating 50 atoms that are randomly decaying at a rate of 0.167 per hour.
`r mcq(c("Throw 50 dice, count how many land on a 6, then repeat with the dice that are remaining.", "Get a spinner with six sections with one section representing decay, spin the spinner and if it lands on the decay section then the atom decayed.", "Throw 50 dice, count how many land on a 6.", "Write some code where the probability of decay is 0.167 and the probability of no decay is 0.833. Run 50 times.", "Write decay on 8 or 9 pieces of paper and mix this in with 41 or 42 pieces of paper that read no decay. Put these in a bag and randomly draw 50 observations.", answer = "Throw 50 dice, count how many land on a 6, then repeat with the dice that are remaining."))`

`r hide("Answer Explanation")`
Throw 50 dice (where the dice represent the atoms), count how many land on a 6 (1/6 is 0.167 so the ones that land on a six are the ones that decay), then repeat with the dice that are remaining (each throw of the dice represent the next hour of decay).
For all the other options, we would need to repeat the process with the remaining non-decayed atoms!
`r unhide()`
...
`r hide("Answer Explanation")`
So, that means 7 atoms decayed in the first hour. 
`r unhide()`

How many atoms are left? `r fitb("43")`
...
paste(x, collapse = ", ")
```
How many atoms decayed this hour? `r fitb("5")`

We repeat this until there are no more atoms left! If everyone in your class did this activity and you combined your plots, we would get something that looks like this:
